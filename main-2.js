...
function init() {
  ...
  // gameover messages
  var msgsSelf = [];
  msgsSelf[0] = "You dead. You died. death.";
  msgsSelf[1] = "Eating yourself is not a solution";
  msgsSelf[2] = "Autocannibalism is not the answer"; 
  msgsSelf[3] = "OK, you should probably get back to work";  
  
  var msgsWall = [];
  msgsWall[0] = "That was a wall, you dead.";
  msgsWall[1] = "My grandma doubled this score";
  msgsWall[2] = "You dead. You died. death.";
  msgsWall[3] = "OK, you should probably get back to work";
  msgsWall[4] = "You need to do better.";
  ...
  reset = function() {
    ...
    function gameover() {
      ...
      tweet.href='http://twitter.com/share?text=I scored ' +score+ ' on MegaSnake! Head to Megaport.com and enter ↑ ↑ ↓ ↓ ← → ← → b a to beat my score! @megaportnetwork';
